...
const PillButton = ({
  ...
  return (
    <button
      className={`shrink-0 whitespace-nowrap rounded-[100px] font-semibold tracking-[-0.8px] transition-colors ${VARIANT_CLASSNAMES[variant]} ${SIZE_CLASSNAMES[size]} ${className}`}
      {...props}
    >
      {children}
    </button>
